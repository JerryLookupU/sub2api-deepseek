...
type AnthropicEventToResponsesState struct {
	...
	CurrentName   string
	// Accumulators used to emit complete output_item.done and response.completed
	// payloads for clients that finalize from terminal events.
	CurrentText      string
