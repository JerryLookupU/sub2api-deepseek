...
const BADGE: Record<Platform, string> = {
  ...
  kimi: 'bg-slate-500/10 text-slate-600 border-slate-500/30 dark:text-slate-300',
}
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  kimi: 'bg-slate-500/10 text-slate-600 dark:bg-slate-500/10 dark:text-slate-300',
}
...
const BORDER: Record<Platform, string> = {
  ...
  kimi: 'border-slate-500/20 dark:border-slate-500/20',
}
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  kimi: 'bg-gradient-to-r from-slate-400 to-slate-500',
}
...
const TEXT: Record<Platform, string> = {
  ...
  kimi: 'text-slate-600 dark:text-slate-300',
}
...
const ICON: Record<Platform, string> = {
  ...
  kimi: 'text-slate-500 dark:text-slate-300',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  kimi: 'bg-slate-700 text-white hover:bg-slate-800 active:bg-slate-900 dark:bg-slate-600 dark:hover:bg-slate-500',
}
...
const DISCOUNT: Record<Platform, string> = {
  ...
  kimi: 'bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  kimi: 'from-slate-600 to-slate-700',
}
